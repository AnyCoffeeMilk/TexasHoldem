...
export default function Profile() {
  ...
  return !playerAvatar ? null : (
    <div className="container-md grid gap-2 rounded-sm p-4 sm:gap-4">
      ...
      <div className="grid gap-2">
        ...
        <div className="grid grid-cols-4 gap-1 sm:grid-cols-5 sm:gap-2 md:grid-cols-6">{avatarSVGMap}</div>
      </div>
      <div className="grid gap-2">
